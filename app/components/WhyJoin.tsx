...
import { whyJoinData } from "../lib/constants";

export function WhyJoin() {
  return (
    <section id="about" className="relative w-full bg-indigo py-24 md:py-28 overflow-hidden">
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#newar)" />
      </svg>
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
          ...
          <p className="font-mono text-sm text-white/40 max-w-sm">
            A 36-hour sprint to build tools that strengthen public safety,
            transparency, and community trust in Lumbini Province.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {whyJoinData.map(({ Icon, title, desc }, i) => (
            <motion.div
              key={title}
