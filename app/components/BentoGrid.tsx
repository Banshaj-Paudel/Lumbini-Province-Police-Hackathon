...
export function BentoGrid() {
  return (
    <section className="relative z-20 -mt-16 mx-auto max-w-7xl w-full px-6 md:px-10 pb-16 md:pb-24" aria-label="Hackathon highlights">
      <ul
      ...
      >
        <motion.article
          ...
          role="listitem"
        >
          <span className="bento-bar absolute left-0 top-0 bottom-0 w-1 bg-gold" aria-hidden="true" />
